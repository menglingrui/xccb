 ...
 * @author dp
 */
public class N_CB05_SAVE extends AbstractCompiler2 {
	...
	public Object runComClass(PfParameterVO vo) throws BusinessException {
		try {
		    ...
		    Object obj1 = runClass("nc.bs.xccb.pub.HYBillCommit", "commitHYBill","nc.vo.pub.AggregatedValueObject:01", vo, m_keyHas,	m_methodReturnHas);
		    return obj1;
		} catch (Exception ex) {
