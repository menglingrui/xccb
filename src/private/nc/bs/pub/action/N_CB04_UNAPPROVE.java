 ...
 * @author mlr
 */
public class N_CB04_UNAPPROVE extends AbstractCompiler2 {
	private java.util.Hashtable m_methodReturnHas = new java.util.Hashtable();
	private Hashtable m_keyHas = null;

	public N_CB04_UNAPPROVE() {
		super();
	}
...
//			CostAccountBO bo=new CostAccountBO();
//			bo.sendMessage_del(vo.m_preValueVo,vo);
//			procUnApproveFlow(vo);
			Object retObj = runClass("nc.bs.xccb.pub.HYBillUnApprove",
